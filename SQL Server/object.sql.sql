...
alter database bikesStores Modify Name = BikeStores;

select * from production.stocks;
select * from production.stocks ORDER BY product_id desc, quantity asc;
select * from sales.customers order by last_name desc, first_name asc, email desc;
